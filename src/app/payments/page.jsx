          ...
          <>
            <div className="stats-grid" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
              ...
              <div className="stat-card">
                ...
                <div className="stat-value success">{fmt(
                  payments.filter(p => p.date?.startsWith(new Date().toISOString().slice(0, 7)))
            ...
            <div className="card card-flush">
              {payments.length === 0 ? (
                <div className="empty">
                  <i className="ti ti-cash-off" aria-hidden="true"></i>
                  <p>No payments recorded yet</p>
                </div>
              ) : (
                <table>
                  <thead>
                    <tr><th>Date</th><th>Invoice #</th><th>Client</th><th>Method</th><th>Amount</th><th>Note</th></tr>
                  </thead>
                  <tbody>
